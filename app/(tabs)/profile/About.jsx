...
const About = () => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Card style={styles.Card}>
        <Card.Content>
        <Text style={styles.donationText}>এই এপটো শ্ৰী মুকুট ভট্টাচাৰ্যই পিতৃ প্ৰয়াত পদুম ভট্টাচাৰ্য আৰু মাতৃ প্ৰয়াত মুক্ত ভট্টাচাৰ্যৰ নামত আগবঢ়াইছে ।</Text>
      </Card.Content>
      </Card>
      ...
      <Text style={styles.shlokaText}>
        ...
        <Text style={styles.shlokaText}>
        ৰূপত শান্তিপূৰ্ণ, নাগৰ ওপৰত শয়ন কৰি থকা, পদুম-নাভিৰে, বিশ্বব্ৰহ্মাণ্ডৰ আধাৰ, দেৱতাৰ প্ৰভু, আৰু আকাশৰ সদৃশ, মেঘৰ ৰং আৰু শুভ অংগ। সকলো ঐশ্বৰ্যপ্ৰেমী, যাৰ চকু পদুমৰ দৰে, যাক যোগীসকলে ধ্যান কৰিব পাৰে, ভগৱান বিষ্ণুলৈ শ্ৰদ্ধাৰে সোঁৱৰিছো।
        </Text> 
      </Card.Content>
      </Card>
    </View>
